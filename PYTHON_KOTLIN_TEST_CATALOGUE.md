...
| `core/tests/test_delete_old_data.py`                               | `services/DeleteOldDataServiceTest.kt`                                                                                             | Management command `delete_old_data` (leaf-row deletion covered; Credit/Disbursement cascade deferred) | ⚠ partial |
