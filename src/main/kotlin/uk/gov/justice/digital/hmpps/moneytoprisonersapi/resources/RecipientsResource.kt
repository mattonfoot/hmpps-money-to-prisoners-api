...
import uk.gov.justice.digital.hmpps.moneytoprisonersapi.dto.RecipientProfile
...
class RecipientsResource(
  ...
  fun listProfiles(
    ...
    principal: Principal,
  ): PaginatedResponse<RecipientProfile> {
  ...
  fun listDisbursements(
    ...
    val results = disbursements.map { Disbursement.from(it, prisonNameMap()) }
    return PaginatedResponse.fromList(results, limit = limit, offset = offset)
  }
