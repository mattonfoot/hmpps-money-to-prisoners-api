...
data class SecurityCredit(
  ...
  companion object {
    fun from(
      credit: uk.gov.justice.digital.hmpps.moneytoprisonersapi.jpa.entities.Credit,
      senderProfileId: Long? = null,
      prisonerProfileId: Long? = null,
    ): SecurityCredit = SecurityCredit(
      id = credit.id,
      ...
      source = CreditSource.UNKNOWN, // Django has no source column on credit_credit
