...
@Schema(name = "ReconcileTransaction", description = "Request body for reconciling transactions within a date range")
data class ReconcileTransactionRequest(
  ...
  val receivedAtGte: OffsetDateTime? = null,
  ...
  val receivedAtLt: OffsetDateTime? = null,
)
