...
class TransactionsResource(
  ...
  fun createTransactions(
    ...
    return transactions.map { Transaction.from(it) }
  }
  ...
  fun listTransactions(
    ...
    val results = transactions.map { Transaction.from(it) }
...
@Schema(name = "PaginatedResponseTransaction", description = "Paginated response containing transaction records")
